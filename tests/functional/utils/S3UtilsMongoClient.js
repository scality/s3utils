        ...
        variations.forEach(variation => {
            describe(variation.it, () => {
                ...
                it(`Should get correct results ${variation.it}`, done => {
                    const expected = {
                        dataManaged: {
                            locations: { 'us-east-1': { curr: BigInt(20), prev: BigInt(0) } },
                            total: { curr: BigInt(20), prev: BigInt(0) },
                        },
                        objects: BigInt(2),
                        stalled: 0,
                        versions: BigInt(0),
        ...
        variations.forEach(variation => {
            ...
            describe(variation.it, () => {
                ...
                itOnlyInV1(`Should get correct results with deleteMarker ${variation.it}`, done => {
                    const expected = {
                        dataManaged: {
                            locations: { 'us-east-1': { curr: BigInt(0), prev: BigInt(20) } },
                            total: { curr: BigInt(0), prev: BigInt(20) },
                        },
                        objects: BigInt(0),
                        stalled: 0,
                        versions: BigInt(2),
                ...
                it('should get correct results with lifecycle replication enabled '
                    ...
                    const expected = {
                        dataManaged: {
                            locations: {
                                'us-east-1': { curr: BigInt(10), prev: BigInt(0) },
                                'completed': { curr: BigInt(10), prev: BigInt(0) },
                            },
                            total: { curr: BigInt(20), prev: BigInt(0) },
                        },
                        objects: BigInt(2),
                ...
                it('should get correct results with lifecycle replication enabled'
                    ...
                    const expected = {
                        dataManaged: {
                            locations: {
                                'us-east-1': { curr: BigInt(20), prev: BigInt(0) },
                                'completed': { curr: BigInt(10), prev: BigInt(0) },
                            },
                            total: { curr: BigInt(30), prev: BigInt(0) },
                        },
                        objects: BigInt(2),
                        stalled: 0,
                        versions: BigInt(0),
                                    ...
                                    locations: {
                                        'cold-location': {
                                            ...
                                            usedCapacity: {
                                                ...
                                                _currentCold: BigInt(0),
                                                nonCurrent: BigInt(0),
                                                _nonCurrentCold: BigInt(10),
                                                _currentRestored: BigInt(0),
                                                _currentRestoring: BigInt(0),
                                                _nonCurrentRestored: BigInt(0),
                                                _nonCurrentRestoring: BigInt(10),
                                                _incompleteMPUParts: BigInt(0),
                                            },
                                        },
                                        'us-east-1': {
