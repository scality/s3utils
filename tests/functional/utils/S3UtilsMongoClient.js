        ...
        variations.forEach(variation => {
            describe(variation.it, () => {
                ...
                it(`Should get correct results ${variation.it}`, done => {
                    const expected = {
                        dataManaged: {
                            locations: { 'us-east-1': { curr: 20n, prev: 0n } },
                            total: { curr: 20n, prev: 0n },
                        },
                        objects: 2n,
                        stalled: 0,
                        versions: 0n,
            ...
            describe(variation.it, () => {
                ...
                it(`Should get correct results ${variation.it}`, done => {
                    const expected = {
                        ...
                        objects: 2n,
                        dataManaged: {
                            total: { curr: 20n, prev: 10n },
                            locations: { 'us-east-1': { curr: 20n, prev: 10n } },
                        },
                        dataMetrics: {
                            account: {
                                [testAccountCanonicalId]: {
                ...
                itOnlyInV1(`Should get correct results with deleteMarker ${variation.it}`, done => {
                    const expected = {
                        dataManaged: {
                            locations: { 'us-east-1': { curr: 0n, prev: 20n } },
                            total: { curr: 0n, prev: 20n },
                        },
                        objects: 0n,
                        stalled: 0,
                        versions: 2n,
                ...
                it('should get correct results with lifecycle replication enabled '
                    ...
                    const expected = {
                        dataManaged: {
                            locations: {
                                'us-east-1': { curr: 10n, prev: 0n },
                                'completed': { curr: 10n, prev: 0n },
                            },
                            total: { curr: 20n, prev: 0n },
                        },
                        objects: 2n,
                ...
                it('should get correct results with lifecycle replication enabled'
                    ...
                    const expected = {
                        dataManaged: {
                            locations: {
                                'us-east-1': { curr: 20n, prev: 0n },
                                'completed': { curr: 10n, prev: 0n },
                            },
                            total: { curr: 30n, prev: 0n },
                        },
                        objects: 2n,
                        stalled: 0,
                        versions: 0n,
