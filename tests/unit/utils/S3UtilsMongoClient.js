...
describe('S3UtilsMongoClient::_handleResults', () => {
    ...
    it('should return correct value if isVer is false', () => {
        ...
        const expectedRes = {
            ...
            objects: 4n,
            dataManaged: {
                total: { curr: 40n, prev: 0n },
                locations: {
                    location1: { curr: 20n, prev: 0n },
                    location2: { curr: 20n, prev: 0n },
                },
            },
            dataMetrics: {
                bucket: {
    ...
    it('should return correct value if isVer is true', () => {
        ...
        const expectedRes = {
            ...
            objects: 4n,
            dataManaged: {
                total: { curr: 40n, prev: 20n },
                locations: {
                    location1: { curr: 20n, prev: 10n },
                    location2: { curr: 20n, prev: 10n },
                },
            },
            dataMetrics: {
                bucket: {
